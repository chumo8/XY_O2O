...
<link rel="stylesheet" type="text/css" href="/commons/icon/ext_icons.css">
<script src="/commons/js/jquery-3.1.1.min.js" type="text/javascript" charset="utf-8"></script>
...
<body>
	<table class="table" style="width: 100%;">
		<tr>
			<td><input name="r" value="icon-blank" type="radio" /></td>
			<td><input name="r" value="icon-add" type="radio" /></td>
			<td><input name="r" value="icon-edit" type="radio" /></td>
			<td><input name="r" value="icon-clear" type="radio" /></td>
			<td><input name="r" value="icon-remove" type="radio" /></td>
			<td><input name="r" value="icon-save" type="radio" /></td>
			<td><input name="r" value="icon-cut" type="radio" /></td>
			<td><input name="r" value="icon-ok" type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="icon-no" type="radio" /></td>
			<td><input name="r" value="icon-cancel" type="radio" /></td>
			<td><input name="r" value="icon-reload" type="radio" /></td>
			<td><input name="r" value="icon-search" type="radio" /></td>
			<td><input name="r" value="icon-print" type="radio" /></td>
			<td><input name="r" value="icon-help" type="radio" /></td>
			<td><input name="r" value="icon-undo" type="radio" /></td>
			<td><input name="r" value="icon-redo" type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="icon-back" type="radio" /></td>
			<td><input name="r" value="icon-sum" type="radio" /></td>
			<td><input name="r" value="icon-tip" type="radio" /></td>
			<td><input name="r" value="icon-filter" type="radio" /></td>
			<td><input name="r" value="icon-man" type="radio" /></td>
			<td><input name="r" value="icon-lock" type="radio" /></td>
			<td><input name="r" value="icon-more" type="radio" /></td>
			<td><input name="r" value="icon-add" type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="icon-mini-add" type="radio" /></td>
			<td><input name="r" value="icon-mini-edit" type="radio" /></td>
			<td><input name="r" value="icon-mini-refresh" type="radio" /></td>
			<td><input name="r" value="icon-large-picture" type="radio" /></td>
			<td><input name="r" value="icon-large-clipart" type="radio" /></td>
			<td><input name="r" value="icon-large-shapes" type="radio" /></td>
			<td><input name="r" value="icon-large-smartart" type="radio" /></td>
			<td><input name="r" value="icon-large-chart" type="radio" /></td>
		</tr>
		<tr>
